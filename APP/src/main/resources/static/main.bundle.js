...
var AppComponent = /** @class */ (function () {
    function AppComponent(_http) {
        ...
        this.petition = [];
        this.tiempos = [1.2, 1.3, 0.8, 0.5, 2.1, 1.3, 1.4, 0.7, 0.4, 0.6];
        this.model2 = {};
        this.ocultaGroupBy = true;
    }
    AppComponent.prototype.enviarPost = function () {
        var req = this._http.post("http://localhost:8080/api/hi/", this.petition, { responseType: 'text' })
    ...
    AppComponent.prototype.resultados = function () {
